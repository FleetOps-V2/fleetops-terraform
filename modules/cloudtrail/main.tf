...
resource "aws_s3_bucket" "cloudtrail_logs" {
  #checkov:skip=CKV2_AWS_62:Event notifications not required for audit log storage bucket
  #checkov:skip=CKV_AWS_144:Cross-region replication not required for CloudTrail logs in this project
